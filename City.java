...
public class City{
    ...
    public City(Random rand, int numMice, int numCats, int numZombieCats, int numFairies) {
        this.rand = rand;
        ...
        for(int i = 0; i<numFairies; i++) addFairy();
        addNewCreatures();
    ...
    public void addFairy(){
        creaturesToAdd.add(new Fairy(rand.nextInt(HEIGHT), rand.nextInt(WIDTH), this,rand));
    }
