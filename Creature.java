...
public class Creature {
    ...
    public void step(){
        ...
        this.point.x = (this.getX()+ (stepLen*dirX[getDir()]) + City.WIDTH) % City.WIDTH;
        this.point.y = (this.getY()  + (stepLen*dirY[getDir()]) + City.HEIGHT) % City.HEIGHT;


    }
    public void takeAction(){}

    public void rightTurn(Creature t){
        t.dir = (t.dir + 1) % 4;
    }


    public void leftTurn(Creature t){
        t.dir = (t.dir + 3) % 4;
    }
